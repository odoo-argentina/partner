...
class res_partner(osv.osv):
    ...
    def check_vat(self, cr, uid, ids):
        ...
        for partner in self.browse(cr, uid, ids):
            ...
            vat_country, vat_number = partner.vat_country.code.lower(), partner.vat.replace(' ', '')
...
# Don't take assumptions on how the VAT should be. Varies greatly from country to country
...
# Temporary function until the country code for United Kingdom is fixed on the country list, from UK to GB.

    def check_vat_uk(self, vat):
        return self.check_vat_gb(vat)
